...
import (
	...
	"github.com/NPeykov/greenlight/internal/jsonlog"
	"github.com/NPeykov/greenlight/internal/mailer"
	_ "github.com/lib/pq"
)
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "e4248910ccd115", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "402439f3713153", "SMTP password")
	...
	logger.PrintInfo("database connected successfully", nil)
